...
<div class="text-box">
	...
	<p>DISCOVER THE BEAUTY OF SANTA CRUZ</p>
</div>
	</section>

	<div style="text-align: center;">
		<h1 style="color: white; font-size:50px;"> SANTA CRUZ </h1>
			...
			<div class="column" style="box-shadow: 0px 3px 8px rgba(0, 0, 0, 0.24);">
				<div class="content">
					...
					<?php
						...
						echo "<br>";
						echo '<span style="color: black; font-size: 12px;"> ' . "Discover the best tourist spot that you can visit.".  '</span><br>';
					?>
