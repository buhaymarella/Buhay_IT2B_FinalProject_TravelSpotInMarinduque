...
<body>
	<section class="banner1" style=" background-image: linear-gradient(rgba(4, 9, 30, 0.7), rgba(4, 9, 30, 0.7)),url(images/gasan-banner.jpg); min-height: 50vh;">
		<nav>
...
<div class="text-box">
	...
	<div style="text-align: center;">
		<h1 style="color: white; font-size:50px;"> GASAN </h1>

		<div class="row" >
			<div class="column" style="box-shadow: 0px 3px 8px rgba(0, 0, 0, 0.24); margin-left: 140px;">
				<div class="content">
					<img src="images/food-banner.jpg" style="width: 320px;height: 180px; margin-top: -43px; margin-left: -44px;">
					<?php
