...
<div class="text-box">
	...
	<h1 style="color: black; font-size:50px; text-align:center;">FAMOUS FOOD IN MOGPOG</h1>
	<div class="container" style="height: 1000px;">

	
<div class="ctr">
  			<img src="images/bagoong.jpg" style="width:100%;">
  			<div class="ct">
  					<?php
						echo '<span style="font-size: 30px; font-weight: bold;"> ' . "DCM BAGOONG FISH SAUCE".  '</span>';

						echo "<br>";
						echo '<span style="color: white; font-size: 15px;"> ' . "Bagoóng made from fish is encompassed by the term bagoóng isdâ  in Mogpog. They can be distinguished further by the type of fish they are made of.  ".  '</span><br><br><br>';
				?>
