...
<div class="text-box">
	...
	<h1 style="color: black; font-size:50px; text-align:center;">FAMOUS FESTIVALS IN SANTA CRUZ</h1>
	<div class="container" style="height: 1000px;">
		<div class="ctr">
  			<img src="images/sta_ati-atihan festival.jpg" style="width:100%;">
		...
		<div class="ctr">
  			<img src="images/moriones.jpeg" style="width:100%;">
  					<div class="ct"  style="box-shadow: rgba(0, 0, 0, 0.24)0px 7px 15px;">

  							<?php 
  					echo '<span style="font-size: 30px; font-weight: bold;"> ' . "<br><br> MORIONES FESTIVAL".  '</span><br>';
